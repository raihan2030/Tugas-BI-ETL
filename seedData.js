...
const seedTransaction = db.transaction(() => {
    ...
    insertSupplier.run(103, 'CV Beras Jaya', 'Jl. Industri No. 12, Bekasi', '08124');
    ...
    insertCustomer.run(703, 'Katering Sehat Ceria', 'Jl. Gatot Subroto No. 25, Jakarta', '08991');
    ...
    insertProduct.run(13, 'Beras Merah Organik', 18000, 67, 1);
    insertProduct.run(14, 'Beras Ketan Putih', 16000, 31, 2);
    ...
    insertReceivingDetail.run(2, 601, 12, 148, 2);
    insertReceivingDetail.run(3, 602, 13, 100, 0);
    insertReceivingDetail.run(4, 603, 11, 298, 2);
